    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        <div class="flex items-center flex-no-shrink">
            <a href="{{ url('/') }}" class="flex items-center flex-no-shrink text-black mx-4">
                ...
                <p class="inline-block font-semibold mx-1 text-grey-dark">Learning Management System (LMS)</p>
            </a>
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/FocussedFlyer3/thestandardsproject" target="__blank" type="black" class="mx-2 px-4">
